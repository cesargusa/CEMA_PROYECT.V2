...
public class initDB {
   ...
   /* 9 */  product.save(new ProductEntity("Vestido croche Zara ",42,"XS","https://images.vinted.net/thumbs/f800/02_01ef8_gdf9CgsgM6rWmP3Zah5QRi31.jpeg?1604770191-0376fe1a1084027a73ad88e01de72608671d933f","Naranja","Seminuevo","Zara","Mujer")); 
            ...
            product.save(new ProductEntity("Camiseta Supreme ",55,"XL","https://images.vinted.net/thumbs/f800/01_01e8f_Yr7rEdmvVqjmjsYCYpwn8c4g.jpeg?1619855925-597f53d4066d68e5b05d64786bb4662c647c0751","Rojo","Nuevo","Supreme","Hombre")); 
    ...
    /* 1 */ categoria.save(new CategoriaEntity("Mujeres","https://img.ltwebstatic.com/images3_pi/2021/04/01/1617245949e0b1217bed1bc05c4793b776d582c880_thumbnail_600x.webp"));
    /* 2 */ categoria.save(new CategoriaEntity("Hombres","https://img.ltwebstatic.com/images3_pi/2021/03/26/16167308995815f2d1e37e211312bb277a0eaf8c00_thumbnail_600x.webp"));  
     /* 3 */categoria.save(new CategoriaEntity("Sudaderas","https://img.ltwebstatic.com/images3_pi/2020/12/22/1608617143339de2ec72e37485120b68fb618ffcc7_thumbnail_600x.webp"));
    /* 4 */categoria.save(new CategoriaEntity("Camisetas","https://img.ltwebstatic.com/images3_pi/2019/10/11/15707838107f3d39d193931dfa2cea95dbec0200b8_thumbnail_600x.webp"));
     /* 5 */ categoria.save(new CategoriaEntity("Abrigos","https://img.ltwebstatic.com/images3_pi/2020/11/09/1604888212bf8d0077ab67f2ae94c04d11f71b1819_thumbnail_600x.webp"));
    /* 6 */ categoria.save(new CategoriaEntity("Bañadores","https://img.ltwebstatic.com/images3_pi/2021/01/13/1610523880d4c7f27652fea3d31fa3e82a1222139f_thumbnail_600x.webp"));
     /* 7 */categoria.save(new CategoriaEntity("Calcetines","https://img.ltwebstatic.com/images3_pi/2021/05/14/1620980706487e1d64398515cf88973bb70bd2a62a_thumbnail_600x.webp"));
      /* 8 */categoria.save(new CategoriaEntity("Zapatillas","https://img.ltwebstatic.com/images3_pi/2021/04/19/1618810391236a16fbd841b3d55b74cf749d2b13fb_thumbnail_600x.webp"));
     /* 9 */ categoria.save(new CategoriaEntity("Accesorios","https://img.ltwebstatic.com/images3_pi/2020/08/06/159668543510dbd73504c030fa50486d3c4e0b74c7_thumbnail_600x.webp")); 
    /*10 */categoria.save(new CategoriaEntity("Pantalones","https://img.ltwebstatic.com/images3_pi/2020/12/03/1606972375e1540d7b31f283215cf43fc5af4fd8cc_thumbnail_600x.webp")); 
         ...
         categoria.save(new CategoriaEntity("Nike","https://logos-marcas.com/wp-content/uploads/2020/04/Nike-Emblema.jpg")); 
          ...
          categoria.save(new CategoriaEntity("Tous","https://www.feelingdaperfume.com/wp-content/uploads/2020/02/Tous.png")); 
            ...
            productoCategoria.save(new ProductoCategoriaEntity(18L, 4L));
            productoCategoria.save(new ProductoCategoriaEntity(18L, 2L));
